...
import { CLIENTS, PRICING_PLANS, USERS, PRICING_CARDS } from '@/lib/constants';
...
const HomePage = () => {
  return (
    <>
      ...
      sm:px-6 flex justify-center items-center flex-col relative'>
        <div
          className='w-[30%]
          blur-[120px]
          rounded-full
        ...
        />
          <TitleSection 
            title='Keep track of your meeting all in one place'
          ...
          <div className='mt-10
            ...
            items-center
            relative 
            sm:ml-0 rounded-2xl border-8 border-washed-purple-300 border-opacity-10
          '>
            <Image 
              src={Cal}
              alt='Banner'
      ...
      <section className='mt-20 px-4 sm:px-6'>
        <TitleSection
            ...
            subheading="Experience all the premium features of out platform. Select a plan that suits yout needs and take your productivity to new heights"
            pill="Pricing"
        />
        <div
            ...
            className={clsx(
              ...
              cardContent={
                <CardContent className='p-0'>
                  ...
                  {+card.price> 0 ? (<span className='dark:text-washed-purple-800 ml-1'>
                    /mo
                  </span>
                  ) : (
                    ''
